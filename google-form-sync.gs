...
FIREBASE_SYNC_CONFIG.fileFieldTitles = [];
// Optional: where uploaded form files should be attached in Drive.
// Leave blank to keep the original Form upload location.
FIREBASE_SYNC_CONFIG.driveFolderId = '4q0u9WSr3WvBLO9t96HPALANiEP8Uvn4SME83p3EpyM6IhtrV6nYNlRi14xX5TyCdm7ljv7a';
// Set true to attempt "Anyone with the link can view" on uploaded files.
FIREBASE_SYNC_CONFIG.makeFilesPublic = true;
